...
/**
 * Instrumented operator for reactor's {@link Flux} operator.
 * @param <T> the type
 */
public class InstrumentedFluxOperator<T> extends FluxOperator<T, T> {
    private final MeterRegistry meterRegistry;
    private final Predicate<Exception> businessExceptionDecisionMaker;
    private final MetricId metricId;

    InstrumentedFluxOperator(Flux source, MeterRegistry meterRegistry, Predicate<Exception> businessExceptionDecisionMaker, MetricId metricId) {
        super(source);
